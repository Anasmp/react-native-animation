    ...
    render() {
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                >
                <TouchableOpacity onPress={() => {this.props.navigation.navigate('OtpScreen'),Keyboard.dismiss()}}>
                ...
                >
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        <Animatable.View
                            ...
                            style={{ backgroundColor: 'white', height: 120, width: 120, alignItems: 'center', justifyContent: 'center',borderRadius:120/2 }}>
                            <Text style={{ fontWeight: 'bold', fontSize: 22 }}>TransOme</Text>
                        </Animatable.View>
                    </View>
                            ...
                            >
                                ...
                                >
                                 ...
                                 <Image
                                        ...
                                        style={{ height: 24, width: 24,marginTop:12, resizeMode: 'contain' }}
                                    />
                                    <Animated.View
                                        pointerEvents="none"
                                        style={{
